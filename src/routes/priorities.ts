...
const router = (fastify, { }, next) => {
  ...
  fastify.put('/:priorityId', { beforeHandler: [fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
  ...
  fastify.delete('/:priorityId', { beforeHandler: [fastify.authenticate] }, async (req: fastify.Request, reply: fastify.Reply) => {
    const priorityId: any = req.params.priorityId;
